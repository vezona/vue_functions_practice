...
const InventoryCaseAPIs = {
  getPublicList: ({
    ...
    return request(
      {
        method: "get",
        url: `https://007-t.houseprice.tw/api/ws/InventoryWebCase/PublicList`,
        params: {
          page,
          keyword,
  ...
  getPrivateList: ({
    ...
    return request(
      {
        method: "get",
        url: `https://007-t.houseprice.tw/api/ws/InventoryWebCase/NonPubliciseList`,
        params: {
          page,
          keyword,
          canContinuePublish: isAllowedRepublish,
  ...
  getCloseList: ({
    ...
    return request(
      {
        method: "get",
        url: `https://007-t.houseprice.tw/api/ws/InventoryWebCase/CloseList`,
        params: {
          page,
          keyword,
          canContinuePublish: isAllowedRepublish,
